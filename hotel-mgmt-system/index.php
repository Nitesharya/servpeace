        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">offers the Roadside Assistance, Hotel Room Facilities, Cab Facilities Package – a 24x7 emergency support provided in the event of any mechanical/electrical breakdown or traffic accident of the vehicle. ... If your car has met with a major accident and is immovable, we will help you to tow your car to the nearest workshop or legal authorities, a 24x7 Hotel room facilities and 24x7 Cab facilities</p>
                </div>
                <div class="col-sm-4 offset-md-1 py-4 text-right">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="http://localhost/vehicleassitancems/index.php" class="text-white my-reservations">Back to RSA<i class="far fa-address-book ml-2"></i></a></li>
                    </ul>
                    <?php } else { ?>
                    <h4>
                    ...
                    <h4>
                        <a href="http://localhost/vehicleassitancems/index.php" class="text-white">Back to RSA </a>
                    </h4>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">Rs:10,000 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">Rs:2000 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">Rs:999 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
